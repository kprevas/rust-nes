...
pub const IX_INSTRUCTIONS: [Opcode; 256] = [
    ...
    // 6x,
    LD(Register(IXH), Register(B)),
    LD(Register(IXH), Register(C)),
    LD(Register(IXH), Register(D)),
    LD(Register(IXH), Register(E)),
    LD(Register(IXH), Register(IXH)),
    LD(Register(IXH), Register(IXL)),
    LD(Register(H), Indexed(IX)),
    LD(Register(IXH), Register(A)),
    LD(Register(IXL), Register(B)),
    LD(Register(IXL), Register(C)),
    LD(Register(IXL), Register(D)),
    LD(Register(IXL), Register(E)),
    LD(Register(IXL), Register(IXH)),
    LD(Register(IXL), Register(IXL)),
    LD(Register(L), Indexed(IX)),
    LD(Register(IXL), Register(A)),
...
pub const IY_INSTRUCTIONS: [Opcode; 256] = [
    ...
    // 6x,
    LD(Register(IYH), Register(B)),
    LD(Register(IYH), Register(C)),
    LD(Register(IYH), Register(D)),
    LD(Register(IYH), Register(E)),
    LD(Register(IYH), Register(IYH)),
    LD(Register(IYH), Register(IYL)),
    LD(Register(H), Indexed(IY)),
    LD(Register(IYH), Register(A)),
    LD(Register(IYL), Register(B)),
    LD(Register(IYL), Register(C)),
    LD(Register(IYL), Register(D)),
    LD(Register(IYL), Register(E)),
    LD(Register(IYL), Register(IYH)),
    LD(Register(IYL), Register(IYL)),
    LD(Register(L), Indexed(IY)),
    LD(Register(IYL), Register(A)),
